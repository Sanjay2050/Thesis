...
public class Block extends javax.swing.JFrame {
    ...
    public Block() {
        initComponents();
         this.setTitle("Block being Added");
    }
        
    public Block (String rest, String PreviousHash, String Data, String PresentHash) 
    {
        initComponents();
        jTextField1.setText(rest);
        jTextField2.setText(PreviousHash);
        jTextField3.setText(Data);
        jTextField4.setText(PresentHash);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Previous Hash value");
